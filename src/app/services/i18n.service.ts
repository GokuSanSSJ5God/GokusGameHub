...
const translations = {
  pl: {
    ...
    movement: 'ruch', rotation: 'obrót', moveDown: 'w dół', drop: 'upuść', restart: 'restart', newGame: 'Nowa gra', backToGames: 'Wróć do gier', score: 'PUNKTY', lines: 'LINIE', length: 'DŁUGOŚĆ', gameOver: 'KONIEC GRY', chiyoDesc: 'Klikaj, aby Chiyo wzbił się wyżej. Omijaj teren, zbieraj złote nasiona i leć jak najdalej.', distance: 'DYSTANS', items: 'PRZEDMIOTY', pause: 'Pauza', resume: 'Wznów', paused: 'PAUZA', speed: 'Prędkość gry', musicOn: 'Włącz muzykę i dźwięki', musicOff: 'Wyłącz muzykę i dźwięki', flyChiyo: 'Leć, Chiyo!', flap: 'Wzleć'
  },
  en: {
    ...
    movement: 'move', rotation: 'rotate', moveDown: 'down', drop: 'drop', restart: 'restart', newGame: 'New game', backToGames: 'Back to games', score: 'SCORE', lines: 'LINES', length: 'LENGTH', gameOver: 'GAME OVER', chiyoDesc: 'Click to help Chiyo fly higher. Avoid the terrain, collect golden seeds and travel as far as possible.', distance: 'DISTANCE', items: 'ITEMS', pause: 'Pause', resume: 'Resume', paused: 'PAUSED', speed: 'Game speed', musicOn: 'Turn music and sounds on', musicOff: 'Turn music and sounds off', flyChiyo: 'Fly, Chiyo!', flap: 'Flap'
  },
  ja: {
    ...
    movement: '移動', rotation: '回転', moveDown: '下へ', drop: '落下', restart: 'リスタート', newGame: '新しいゲーム', backToGames: 'ゲーム一覧へ', score: 'スコア', lines: 'ライン', length: '長さ', gameOver: 'ゲームオーバー', chiyoDesc: 'クリックしてチヨを高く飛ばそう。地形を避け、金色の種を集めて、できるだけ遠くまで飛ぼう。', distance: '距離', items: 'アイテム', pause: '一時停止', resume: '再開', paused: '一時停止中', speed: 'ゲーム速度', musicOn: '音楽と効果音をオン', musicOff: '音楽と効果音をオフ', flyChiyo: '飛べ、チヨ！', flap: '羽ばたく'
  }
} as const;

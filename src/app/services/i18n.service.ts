...
const translations = {
  pl: {
    ...
    movement: 'ruch', rotation: 'obrót', moveDown: 'w dół', drop: 'upuść', restart: 'restart', newGame: 'Nowa gra', backToGames: 'Wróć do gier', score: 'PUNKTY', lines: 'LINIE', length: 'DŁUGOŚĆ', gameOver: 'KONIEC GRY', chiyoDesc: 'Klikaj, aby Chiyo wzbił się wyżej. Omijaj teren, zbieraj złote nasiona i leć jak najdalej.', distance: 'DYSTANS', items: 'PRZEDMIOTY', pause: 'Pauza', resume: 'Wznów', paused: 'PAUZA', speed: 'Prędkość gry', musicOn: 'Włącz muzykę i dźwięki', musicOff: 'Wyłącz muzykę i dźwięki', gridOn: 'Włącz siatkę', gridOff: 'Wyłącz siatkę', flyChiyo: 'Leć, Chiyo!', flap: 'Wzleć'
  },
  en: {
